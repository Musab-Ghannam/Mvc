...
namespace taskApi13_2_2023.Controllers
{
    public class Faculties1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "faculty_id,facultyName,facultyimg,facultydesc")] Faculty faculty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "faculty_id,facultyName,facultyimg,facultydesc")] Faculty faculty)
        {
            if (ModelState.IsValid)
            {
